...
4. Accepted participants gain access to the event room, precise meeting instructions, and in-product host update history for later event edits. Opening the room marks the newest host update as seen.
