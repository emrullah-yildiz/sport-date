...
- Authorized room payloads now include recent host update history so native event-day surfaces can show when time, venue, or arrival details changed without depending on push or chat.
