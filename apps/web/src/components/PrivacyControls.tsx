    ...
    <section className="privacy-panel" aria-labelledby="privacy-title">
      <div>
        ...
        <p className="privacy-inline-note">
          Read the <Link href="/privacy">Privacy Notice preview</Link>, <Link href="/terms">Terms preview</Link>, and <Link href="/safety#guidelines">safety guidance</Link> for the current member-facing boundary. Optional product-update preferences live separately so terms acceptance is not treated as marketing consent.
        </p>
