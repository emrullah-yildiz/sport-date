...
export const metadata: Metadata = {
  ...
  description:
    "Meet compatible people through small, local sports — from running and padel to chess. Adults 18+, privacy-first — first events in Europe.",
  ...
  twitter: {
    ...
    title: BRAND_TITLE,
    description:
      "Meet compatible people through small, local sports. Adults 18+, privacy-first — first events in Europe.",
